...
lw = 2                                  # 线条大小
colors = ['red','blue']                 # 使用的线条颜色
title = 'Xception'
paths = {                               # 加载ROC曲线的路径
        "Post-image":r'C:\Users\Administrator\Desktop\classification\output\waterT1C-post\image\xception\val-model_best-patient-roc.json',
        # "train":r'C:\Users\Administrator\Documents\vscode\classification\output\task2\image\efficientnet_b0\train-model_best-image-roc.json',
        "Pre-image":r'C:\Users\Administrator\Desktop\classification\output\waterT1C-pre\image\xception\val-model_best-patient-roc.json'
        }
save_dir = r'C:\Users\Administrator\Desktop\classification\output\waterT1C-post\image'     # 保存ROC的路径
save_name = 'ROC-xception-pre-post'                                                                                               # 保存生成文件的名字
